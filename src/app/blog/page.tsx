  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950 flex items-center justify-center px-6">
      <div className="max-w-md text-center">
        ...
        <h1 className="text-2xl font-black tracking-tight text-zinc-900 dark:text-white mb-3">Blog — coming soon</h1>
        <p className="text-zinc-600 dark:text-zinc-400 mb-8">
          We're working on GST compliance guides, product updates, and retail operations tips.
          In the meantime, reach out with questions directly.
        </p>
