...
export const metadata = {
  title: "Terms of Service — managemycounter",
};
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950 flex items-center justify-center px-6 py-24">
      <div className="max-w-lg text-center">
        ...
        <h1 className="text-2xl font-black tracking-tight text-zinc-900 dark:text-white mb-3">Terms of Service</h1>
        <p className="text-zinc-600 dark:text-zinc-400 mb-8">
          We're finalizing our full terms of service documentation. managemycounter is currently in
          private beta — every invited shop gets full access at no cost, with no long-term
          commitment. For any questions in the meantime, email us directly.
        </p>
