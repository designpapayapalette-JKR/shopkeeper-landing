  ...
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      className={cn(
        ...
        side === "top" &&
          "border-b top-0 left-0 right-0 h-[--radix-sheet-height] data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top",
        side === "bottom" &&
          "border-t left-0 right-0 bottom-0 h-[--radix-sheet-height] data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
        side === "left" &&
          "border-r top-0 bottom-0 left-0 h-full w-[--radix-sheet-width] data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:max-w-sm",
        side === "right" &&
          "border-l top-0 bottom-0 right-0 h-full w-[--radix-sheet-width] data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-sm",
        className
      )}
      {...props}
    >
