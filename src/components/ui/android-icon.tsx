...
// The standard Android robot mark — used purely to indicate Android
// platform availability (same convention as any "Available on Android"
// badge). Inline SVG rather than a dependency since lucide-react (the
// only icon set already in this project) only has generic device icons,
// not platform/brand marks.
